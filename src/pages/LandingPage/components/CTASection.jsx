        ...
        <section className="max-w-4xl mx-auto px-4 py-24 w-full text-center">
            <div className="bg-gradient-to-b from-surface-light to-transparent border border-[#e9e8ce] rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button className="bg-primary hover:bg-[#e6e205] text-text-main px-8 py-4 rounded-full font-bold text-base transition-all active:scale-95 w-full sm:w-auto shadow-lg shadow-primary/20">
                        Start a Project
                    </button>
                    <button className="bg-white border border-[#e9e8ce] hover:bg-gray-50 text-text-main px-8 py-4 rounded-full font-bold text-base transition-all active:scale-95 w-full sm:w-auto">
